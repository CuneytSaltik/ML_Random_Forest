...
df = pd.get_dummies(df, columns=['src_port', 'dst_port', 'protocol', 'bidirectional_first_seen_ms',
                                 ...
                                 'src2dst_duration_ms', 'src2dst_packets', 'src2dst_bytes', 'dst2src_first_seen_ms',
                                 ...
                                 'dst2src_max_ps', 'bidirectional_mean_piat_ms', 'bidirectional_stddev_piat_ms',
                                 'bidirectional_max_piat_ms', 'src2dst_mean_piat_ms', 'src2dst_stddev_piat_ms',
                                 'src2dst_max_piat_ms', 'dst2src_mean_piat_ms', 'dst2src_stddev_piat_ms',
                                 ...
                                 'dst2src_ack_packets', 'dst2src_psh_packets', 'dst2src_fin_packets'],
                    drop_first=True)
print(df.columns)
